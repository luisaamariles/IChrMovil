...
public class MapsActivity extends MainActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final LatLng inter = new LatLng(6.213850, -75.558241);
        mMap.addMarker(new MarkerOptions().position(inter).title("Hotel Intercontinental"));

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(inter,15));
